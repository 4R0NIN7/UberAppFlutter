...
const Readings$json = const {
  ...
  '2': const [
    ...
    const {'1': 'hummidity', '3': 2, '4': 1, '5': 13, '10': 'hummidity'},
  ],
};

/// Descriptor for `Readings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List readingsDescriptor = $convert.base64Decode('CghSZWFkaW5ncxIgCgt0ZW1wZXJhdHVyZRgBIAEoAlILdGVtcGVyYXR1cmUSHAoJaHVtbWlkaXR5GAIgASgNUglodW1taWRpdHk=');
